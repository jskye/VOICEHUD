...
//	+ screen.layoutviewsCallCount+ screen.debugOutput());
	...
	for(Element view : screen.getLayerElements()){
		...
		if (!selectedview.getViewname().equals(getBaseHUDView()) && hudVisible
			...
			ScreenController viewsViewController= null;
//			try{
//				HUDGUI hudgui = null;
